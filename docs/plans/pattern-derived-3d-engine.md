...
The final numerical/supervision regression run passes **716 tests in 288.967 seconds** on pinned Linux ARM. This verifies the offline checkpoint, not garment construction or an application release.
