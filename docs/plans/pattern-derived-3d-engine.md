...
The final numerical/supervision regression run passes **756 tests in 347.358 seconds** on pinned Linux ARM. This verifies the offline checkpoint, not garment construction or an application release.
