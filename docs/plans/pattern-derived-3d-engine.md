...
The final numerical/supervision regression run passes **796 tests in 422.720 seconds** on pinned Linux ARM. This verifies the offline checkpoint with the proposed refined runner/main-replay integration still unapplied, not garment construction or an application release.
