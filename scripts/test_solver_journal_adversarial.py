...
class JournalAdversarialTests(unittest.TestCase):
    ...
    def test_underflow_finishes_without_start_or_solver_execution(self):
        ...
        solver = mock.Mock(sewing_mode="vector", fold_actuation=None, controlled_fold_actuation=None,
                           material_grippers=None, continuous_cable=None, cable_parameter_control=None,
                           contact_work_control=None)
