...
The pinned geometry engine supports ONLY: shirt = symmetric sleeveless top with curved armholes and round neckline, no collar/sleeve panels; skirt = circular two-panel skirt with natural waist, no waistband or closure; trousers = four-panel darted natural-waist trousers, no waistband, closure, pockets or cuffs.
...
Choose family none if no honest partial geometry represents the garment. Never silently substitute a different garment. Preserve EVERY requested feature as a separate requirement, especially unsupported construction, asymmetry, sleeves, closures, decoration and fabric/color. Status supported is only for these explicit geometry controls; other requirements are unsupported or unresolved with an explanation of what still needs doing. Do not claim fabric/color are represented in geometry.
