...
export const interpretationFixture:Interpretation={
  ...
  garment:{family:'shirt',length:assumed(600),ease:assumed(80),flare:1.1,design:null},
  requirements:[{text:'Sleeveless round-neck top',status:'supported',note:'The current shirt adapter supports this base shape.',feature:'body'},{text:'Blue linen with contrast embroidery',status:'unsupported',note:'Fabric, color and embroidery are preserved in the BOM and brief; geometry does not implement them.',feature:'other'}],
